...
valid_scores.to_csv('data/blend/valid_fastai_nn_single.csv', index=False)
...
train_scores.to_csv('data/blend/train_fastai_nn_single.csv', index=False)
...
test_raw[['Id', 'Predicted']].to_csv('submissions/fastai_nn_single.csv', index=False)
